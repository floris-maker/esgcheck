...
PROVIDERS = [
    ...
    {"name": "FortiMail Cloud", "category": SECURITY_GATEWAY,
     "patterns": ["fortimail.com", "fortimailcloud.com"]},
    {"name": "Hornetsecurity", "category": SECURITY_GATEWAY,
     "patterns": ["antispameurope.com", "hornetsecurity.com"]},
    {"name": "AppRiver / Zix", "category": SECURITY_GATEWAY,
     "patterns": ["arsmtp.com"]},
    {"name": "Retarus", "category": SECURITY_GATEWAY,
     "patterns": ["retarus.com"]},
    {"name": "N-able Mail Assure", "category": SECURITY_GATEWAY,
     "patterns": ["antispamcloud.com", "spamexperts.com"]},
    {"name": "SpamTitan", "category": SECURITY_GATEWAY,
     "patterns": ["titanhq.com"]},
    {"name": "MailRoute", "category": SECURITY_GATEWAY,
     "patterns": ["mroute.net"]},
    {"name": "SpamHero", "category": SECURITY_GATEWAY,
     "patterns": ["spamhero.com", "spamhero.net"]},
    {"name": "Libraesva", "category": SECURITY_GATEWAY,
     "patterns": ["libraesva.com"]},
    {"name": "FuseMail (VIPRE)", "category": SECURITY_GATEWAY,
     "patterns": ["electric.net"]},
